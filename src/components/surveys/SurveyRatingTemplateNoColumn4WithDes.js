/*************************************************
 * Class Name: SurveyRatingTemplateNoColumn4WithDes
...
class SurveyRatingTemplateNoColumn4WithDes extends Component {
        ...
        return ( 
            ...
            <table>
                <tbody>
                    ...
                    <td style={{padding: 0, textAlign:'center', width: '29%'}} colSpan={4}>{this.props.des0Value}</td>
                ...
                <tbody>
                    <tr style={{border:'hidden'}}>
                    <td style={{padding: 0, textAlign:'center'}} colSpan={4}>{this.props.col0Value}</td>
...
export default SurveyRatingTemplateNoColumn4WithDes