...
class Survey20m extends Component {
        ...
        return ( 
            ...
            <table>
                <tbody>
                    ...
                    <td style={{padding: 0, textAlign:'center', fontWeight:'bold'}}>{this.props.des01Value}</td>   
                ...
                <tbody>
                    <tr style={{border:'hidden'}}>
                    <td style={{padding: 0, textAlign:'center', fontWeight:'bold'}}>{this.props.col01Value}</td>
