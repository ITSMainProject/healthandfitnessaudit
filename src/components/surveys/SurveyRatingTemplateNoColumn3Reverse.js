/*************************************************
 * Class Name: SurveyRatingTemplateNoColumn3Reverse
...
class SurveyRatingTemplateNoColumn3Reverse extends Component {
        ...
        return ( 
            ...
            <table>
                ...
                <tr style={{border:'hidden'}}>
                    ...
                    <td style={{padding: 0, textAlign:'center', width: '19%'}}>{this.props.des10Value}</td>
                ...
                <tbody>
                    ...
                    <td style={{padding: 0, textAlign:'center', width: '19%'}}>{this.props.col10Value}</td>
                    <td style={{padding: 0}} colSpan={1}></td>
                    </tr>
...
export default SurveyRatingTemplateNoColumn3Reverse