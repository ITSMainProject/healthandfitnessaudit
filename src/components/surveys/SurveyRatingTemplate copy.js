...
class SurveyRatingTemplateV2 extends Component {
        ...
        return ( 
            ...
            <table>
                <tbody>
                    ...
                    <td style={{padding: 0, textAlign:'centre'}}>{this.props.col0Value}</td>
                    <td style={{padding: 0, textAlign:'centre'}}>{this.props.col1Value}</td>
                    <td style={{padding: 0, textAlign:'centre'}}>{this.props.col2Value}</td>
                    <td style={{padding: 0, textAlign:'centre'}}>{this.props.col3Value}</td>
                    <td style={{padding: 0, textAlign:'centre'}}>{this.props.col4Value}</td>
                    <td style={{padding: 0, textAlign:'centre'}}>{this.props.col5Value}</td>
                    <td style={{padding: 0, textAlign:'centre'}}>{this.props.col6Value}</td>
                    <td style={{padding: 0, textAlign:'centre'}}>{this.props.col7Value}</td>
                    <td style={{padding: 0, textAlign:'centre'}}>{this.props.col8Value}</td>
                    <td style={{padding: 0, textAlign:'centre'}}>{this.props.col9Value}</td>
                    <td style={{padding: 0, textAlign:'centre'}}>{this.props.col10Value}</td>
...
export default SurveyRatingTemplateV2
