...
class SurveyRatingTemplate extends Component {
        ...
        return ( 
            ...
            <table>
                <tbody>
                    ...
                    <td style={{padding: 0}} colSpan={3}>{this.props.leftValue}</td>
                    <td style={{padding: 0}} colSpan={3}>{this.props.secondValue}</td>
                    <td style={{padding: 0}} colSpan={3}>{this.props.thirdValue}</td>
                    <td style={{padding:0, textAlign:'right'}} colSpan={2}>{this.props.rightValue}</td>
...
export default SurveyRatingTemplate
