/*************************************************
 * Class Name: SurveyRatingTemplateFitnessV3
...
class SurveyRatingTemplateFitnessV3 extends Component {
        ...
        return ( 
            ...
            <table>
                <tbody>
                    ...
                    <td style={{padding: 0, textAlign:'center'}} colSpan={3}>{this.props.top0Value}</td>

                    <td style={{padding: 0, textAlign:'center'}}>{this.props.top3Value}</td>
                    <td style={{padding: 0, textAlign:'center'}}>{this.props.top4Value}</td>
                    <td style={{padding: 0, textAlign:'center'}}>{this.props.top5Value}</td>
                    <td style={{padding: 0, textAlign:'center'}}>{this.props.top6Value}</td>
                    <td style={{padding: 0, textAlign:'center'}}>{this.props.top7Value}</td>
                    <td style={{padding: 0, textAlign:'center'}}>{this.props.top8Value}</td>
                    <td style={{padding: 0, textAlign:'center'}}>{this.props.top9Value}</td>
                    <td style={{padding: 0, textAlign:'center'}}>{this.props.top10Value}</td>
                ...
                <tbody>
                    <tr style={{border:'hidden'}}>
                    <td style={{padding: 0, textAlign:'center'}} colSpan={3}>{this.props.des0Value}</td>
                ...
                <tbody>
                    <tr style={{border:'hidden'}}>
                    <td style={{padding: 0, textAlign:'center'}} colSpan={3}>{this.props.col0Value}</td>
                ...
                <tbody>
                    <tr style={{border:'hidden'}}>
                        <td style={{padding: 0}} colSpan={3}>
                            <div id="col" className="col s1 customcol customs1" style={{backgroundColor: '0'===this.state.col && this.state.temcol ? "#ff0000":""}}></div>    
                        </td>
...
export default SurveyRatingTemplateFitnessV3