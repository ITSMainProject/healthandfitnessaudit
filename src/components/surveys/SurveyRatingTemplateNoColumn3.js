/*************************************************
 * Class Name: SurveyRatingTemplateNoColumn3
...
class SurveyRatingTemplateNoColumn3 extends Component {
        ...
        return ( 
            ...
            <table>
                ...
                <tr style={{border:'hidden'}}>
                    <td style={{padding: 0, textAlign:'center', width: '19%'}} colSpan={3}>{this.props.des0Value}</td>
                ...
                <tbody>
                    <tr style={{border:'hidden'}}>
                        ...
                        <td style={{padding: 0}}>
                            <div id="col" onClick={() => { (this.divClicked('3'));}} className="col s1 customcol customs1" style={{backgroundColor: '3'===this.state.col ? "#ff6000":""}}>3</div>
                        </td>
                        <td style={{padding: 0}}>
...
export default SurveyRatingTemplateNoColumn3