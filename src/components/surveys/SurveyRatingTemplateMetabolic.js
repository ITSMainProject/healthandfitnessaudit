/*************************************************
 * Class Name: SurveyRatingTemplateMetabolic
...
class SurveyRatingTemplateMetabolic extends Component {
    ...
    render() {
        return ( 
            ...
            <table>
                ...
                <tbody>
                    <tr>
                    <td style={{padding: 10, border:'hidden'}} colSpan={12}>Scores based on percent body fat .....</td>
                    </tr>

                </tbody>
                <tbody>
                    <tr style={{border:'hidden'}}>
                    <td style={{padding: 0, textAlign:'center'}} colSpan={3}>{"Man >40"}</td>
                    <td style={{padding: 0, textAlign:'center'}}>{"<35"}</td>
                    <td style={{padding: 0, textAlign:'center'}}>{"<30"}</td>
                    <td style={{padding: 0, textAlign:'center'}}>{"<28"}</td>
                    <td style={{padding: 0, textAlign:'center'}}>{"<26"}</td>
                    <td style={{padding: 0, textAlign:'center'}}>{"<24"}</td>
                    <td style={{padding: 0, textAlign:'center'}}>{"<22"}</td>
                    <td style={{padding: 0, textAlign:'center'}}>{"<20"}</td>
                    <td style={{padding: 0, textAlign:'center'}}>{"<18"}</td>
                    <td style={{padding: 0}} colSpan={1}></td>
                    </tr>
                ...
                <tbody> 
                    <tr style={{border:'hidden'}}>
                    <td style={{padding: 0, textAlign:'center'}} colSpan={3}>{"Woman >45"}</td>
                    <td style={{padding: 0, textAlign:'center'}}>{"<45"}</td>
                    <td style={{padding: 0, textAlign:'center'}}>{"<40"}</td>
                    <td style={{padding: 0, textAlign:'center'}}>{"<38"}</td>
                    <td style={{padding: 0, textAlign:'center'}}>{"<36"}</td>
                    <td style={{padding: 0, textAlign:'center'}}>{"<34"}</td>
                    <td style={{padding: 0, textAlign:'center'}}>{"<32"}</td>
                    <td style={{padding: 0, textAlign:'center'}}>{"<30"}</td>
                    <td style={{padding: 0, textAlign:'center'}}>{"<28"}</td>
                    <td style={{padding: 0}} colSpan={1}></td>
                    </tr>
...
export default SurveyRatingTemplateMetabolic