/*************************************************
 * Class Name: SurveyRatingTemplateNoColumn4
...
class SurveyRatingTemplateNoColumn4 extends Component {
        ...
        return ( 
            ...
            <table>
                <tbody>
                    ...
                    <td style={{padding: 0, textAlign:'center', width: '29%'}} colSpan={4}>{this.props.col0Value}</td>
...
export default SurveyRatingTemplateNoColumn4